...
namespace MeesGame
{
    public class Player : SmoothlyMovingGameObject
    {
        ...
        public Player(Level level, Point location, int layer = 0, string id = "", int score = 0) : base(GenerateSpriteSheets(), level.Tiles,level.TimeBetweenActions,"playerdown@4", layer, id)
        {
            Score = score;
            Level = level;
            Teleport(location);
        ...
        private static Dictionary<Direction, SpriteSheet> GenerateSpriteSheets()
        {
            Dictionary<Direction, SpriteSheet> sprites = new Dictionary<Direction, SpriteSheet>();
            sprites.Add(Direction.NORTH, new SpriteSheet("playerup@4"));
            sprites.Add(Direction.EAST, new SpriteSheet("playerright@4"));
            sprites.Add(Direction.SOUTH, new SpriteSheet("playerdown@4"));
            sprites.Add(Direction.WEST, new SpriteSheet("playerleft@4"));
            return sprites;
        }
    }
}
