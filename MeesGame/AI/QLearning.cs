...
namespace AI
{
    ...
    class AILevelState
    {
        ...
        {
            var a = obj as AILevelState;

            if (this.location == a.location && this.keysInInventory == a.keysInInventory)
            {
                return true;
            }
    ...
    class QLearning : IAI
    {
        ...
        private AILevelState GetNewAILevelState(IPlayer clone, PlayerAction a)
        {
            ...
            IPlayer clone2 = player.Clone();
            clone2.PerformAction(a);
            AILevelState newAILevelState = new AILevelState(clone2.Location, temporaryKeyList);
